      ...
      <section id="projects" className="px-6 pb-32 max-w-[1200px] mx-auto">
        ...
        <div className="projects-grid">
          {projects.map((project) => (
            ...
            >
              <article className="relative h-full rounded-xl overflow-hidden bg-white dark:bg-[var(--surface)] shadow-[0_0_0_1px_var(--border)] transition-all duration-300 flex flex-col">
